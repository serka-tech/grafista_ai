...
designReferencesRouter.get('/:clientId/design-references', async (req: Request, res: Response) => {
...
designReferencesRouter.post('/:clientId/design-references', upload.single('file'), async (req: Request, res: Response) => {
